...
- [Low Issues](#low-issues)
  ...
  - [L-13: Inconsistency in declaring uint256/uint (or) int256/int variables within a contract](#l-13-inconsistency-in-declaring-uint256uint-or-int256int-variables-within-a-contract)
...
- Found in src/stPlumeRewards.sol [Line: 107](src/stPlumeRewards.sol#L107)
...
## L-13: Inconsistency in declaring uint256/uint (or) int256/int variables within a contract
...
- Found in src/OperatorRegistry.sol [Line: 28](src/OperatorRegistry.sol#L28)

	```solidity
	contract OperatorRegistry is OwnedUpgradeable {
	```

- Found in src/stPlumeMinter.sol [Line: 19](src/stPlumeMinter.sol#L19)
